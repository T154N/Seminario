package com.pedido_flex.wsPedidoFlex.Utils.Specifications;
...
public class SearchClientesSpecification implements Specification<Cliente> {
    ...
    public SearchClientesSpecification(Long id, String nombre, String apellido, String email, String telefono, String direccion,Long estadoId) {
        this.id = id;
        this.nombre = nombre;
